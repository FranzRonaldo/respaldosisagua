            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('propiedades.update', $propiedad->id) }}" method="POST">
                        @csrf
                        @method('PATCH') <!-- Método PATCH para actualización -->

                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="persona_id" class="form-label">Persona:</label>
                                    <select name="persona_id" id="persona_id" class="form-select select2" required>
                                        <option value="">Seleccione una persona</option>
                                        @foreach ($personas as $persona)
                                            <option value="{{ $persona->id }}" {{ old('persona_id', $propiedad->persona_id) == $persona->id ? 'selected' : '' }}>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="red" id="red" class="form-control" value="{{ old('red', $propiedad->red) }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="fecha_ingreso" class="form-control" id="fecha_ingreso" value="{{ old('fecha_ingreso', $propiedad->fecha_ingreso) }}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="estado" id="estado" class="form-select" required>
                                        <option value="1" {{ old('estado', $propiedad->estado) == 1 ? 'selected' : '' }}>Activo</option>
                                        <option value="0" {{ old('estado', $propiedad->estado) == 0 ? 'selected' : '' }}>Inactivo</option>
                                    </select>
                                </div>
                            </div>
                        </div>
