...
@section('content')
    @component('common-components.breadcrumb')
        ...
        @slot('title') Consumos Pendientes @endslot
    @endcomponent
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="row mb-2">
                    ...
                    <h4 class="card-title">Consumos con Pago Pendiente</h4>

                    <!-- Formulario para seleccionar el mes -->
                    <form action="{{ route('consumos.pendientes') }}" method="GET" class="mb-4">
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-4 d-flex gap-2">
                                    ...
                                    <a href="{{ route('consumos.pendientes.pdf', ['mes' => request('mes')]) }}" class="btn btn-success">Descargar Reporte</a>
                                </div>
                            </div>
                        </form>
                    ...
                    @if($consumos->isEmpty())
                        <p class="text-center">No hay consumos pendientes para el mes seleccionado.</p>
                    @endif
                </div>
            </div>
        </div>
