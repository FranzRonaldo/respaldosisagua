...
<head>
    <meta charset="UTF-8">
    <title>Reporte de Consumos Pagados</title>
    <style>
        body {
...
<body>
    <div class="main-container">
        <div class="header">
            ...
            <h2>Reporte de Consumos Pagados</h2>
        ...
        <div class="total-ingresado">
            <strong>Total Ingresado:</strong> {{ number_format($totalIngresado, 2) }} Bs
        </div>

        <!-- Tabla de consumos pagados -->
        ...
        @else
            <p class="no-data">No hay consumos pagados para el mes seleccionado.</p>
        @endif
    </div>
</body>
</html>
