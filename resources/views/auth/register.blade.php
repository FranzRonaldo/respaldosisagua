                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                                            name="email" value="{{ old('email') }}" id="email" placeholder="Escriba su correo electronico">
                                        @error('email')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" class="form-control @error('password') is-invalid @enderror"
                                            name="password" id="userpassword" placeholder="Ingrese su contraseña">
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="auth-terms-condition-check">Acepto <a
                                                href="javascript: void(0);" class="text-dark">Terminos y Condiciones</a></label>
                                    </div>
